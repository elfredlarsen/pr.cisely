  ...
  const renderTimeCell = (m: Measurement, field: "start" | "end") => {
    ...
    return (
      <button
        ...
        className="group inline-flex h-8 w-auto min-w-[7rem] items-center justify-start gap-1.5 rounded px-1 py-0.5 text-xs tabular-nums text-muted-foreground transition-all duration-150 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
      >
        <span>{value}</span>
