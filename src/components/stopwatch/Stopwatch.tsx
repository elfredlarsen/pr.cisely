...
export function Stopwatch({ onRequestFinish, finishOpen = false, resetKey = 0 }: Props) {
  ...
  return (
    <section
      ...
      className={`flex w-full flex-col items-center justify-center gap-12 px-6 py-12 transition-opacity duration-200 ${finishOpen ? "pointer-events-none opacity-15" : "opacity-100"}`}
    >
